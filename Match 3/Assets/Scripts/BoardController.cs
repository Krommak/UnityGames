...
public class BoardController : MonoBehaviour
{
    ...
    #region(Выделить, снять выделение, управление выделением тайлов)
    ...
    private void CheckSelectTile(Tile tile)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                // новое выделение, забываем старый
                else
                {
                    DeselectTile(oldSelectTile);
                    SelectTile(tile);
    ...
    #region(Поиск совпадения, удаление, поиск всех совпадений)
    ...
    private void SwapToTile(Tile tile)
    {
    ...
    private List<Tile> AdjacentTiles()
    {
        ...
        for (int i = 0; i < dirRay.Length; i++)
        {
            ...
            {
                cashTiles.Add(hit.collider.GetComponent<Tile>());
            }
        }
        return cashTiles;
    }
    ...
    #region(Поиск пустого тайла, сдвиг тайла вниз, установка нового изображения, Выбор нового изображения)
